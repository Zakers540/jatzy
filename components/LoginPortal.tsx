                ...
                <div className="bg-white/64 p-8 max-w-lg w-full rounded-md max-h-124 border-1 border-white/80">
                    { players && !(players[0]==="") && !selectedOpret && !selectedPlayer ? (
                        <div className="flex flex-col px-4">
                            ...
                            <div className="mt-6"><span className="text-black/80">Har I ikke en gruppe?</span> <button className="text-black/80 font-medium hover:text-blue-500" onClick={()=> {setSelectedOpret(true)}}>Opret en</button> </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="w-full flex flex-col gap-4">
                                <div className="flex flex-col">
                                    <label htmlFor="name" className="text-black/60 mb-2">Hvad ville I blive kaldt?</label>
                                    <input
                                        type="text"
                                        placeholder="Poul"
                                        value={playerName}
                                ...
                                <div className="flex flex-col">
                                    <label htmlFor="name" className="text-black/60 mb-2">Hvad skal jeres adgangskode være?</label>
                                    <input
                                        type="password"
                                ...
                                <div className="flex flex-col">
                                    <label htmlFor="name" className="text-black/60 mb-2">Bekræft jeres adgangskode.</label>
                                    <input
                                        type="password"
                        ...
                        <div>
                            ...
                            <div className="w-full flex flex-col gap-4">
                                <div className="flex flex-col">
                                    <label htmlFor="name" className="text-black/60 mb-2">Hvad er jeres adgangskode?</label>
                                    <input
                                        type="password"
                                        placeholder="Adgangskode"
                                        className="input"
