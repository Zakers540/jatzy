export default function Footer () {
    return (
        <footer className="flex justify-center mt-8 bg-green-50/20 dark:bg-[#041F12]/20">
                ...
                <div className="flex flex-col justify-center md:block">
                    ...
                    <div className="flex flex-col items-center md:ml-4 md:block">
                        <div className="mt-6 flex flex-col items-center justify-center md:justify-start md:items-start space-y-4 font-extralight">
                            <p>© 2025 <a href="https://www.chrestensoelberg.dk/">Chresten</a> & <a href="https://github.com/Zakers540">Niklas</a></p>
                        </div>
                    </div>
                </div>
                <div className="flex flex-col items-center md:items-start md:flex-row text-neutral-700 dark:text-neutral-200 md:space-x-24">
