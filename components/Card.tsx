...
export default function Card({ title, description }: CardProps) {
    return (
        <div className="group cursor-default p-5 flex flex-col w-64 h-44 rounded-2xl border-2 border-black/20 bg-white/20 shadow-md transition-all duration-300 ease-in-out hover:shadow-xl hover:border-black/80 hover:bg-gradient-to-tr hover:from-blue-100 hover:to-green-100">
            ...
            <h2 className="text-2xl text-center font-semibold text-black transition-colors duration-300 ">
                {title}
            </h2>
